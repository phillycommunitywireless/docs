...
![Materials](./mesh-images/Materials.jpeg)
...
![Ports](./mesh-images/Ports.jpeg)
![Wiring](./mesh-images/Wiring.jpeg)
...
1. With the paperclip, press the reset button at the bottom of the AP Mesh Unit in until it clicks. ![Reset Button](./mesh-images/Reset.jpeg)
...
![SSH Connection](./mesh-images/SSH.png)
